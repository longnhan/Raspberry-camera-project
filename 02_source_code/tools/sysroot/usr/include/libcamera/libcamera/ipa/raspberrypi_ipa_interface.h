...
public:
	...
	InitParams(bool _lensPresent, const IPACameraSensorInfo &_sensorInfo)
		: lensPresent(_lensPresent), sensorInfo(_sensorInfo)
	{
	}
#endif
...
public:
	...
	Signal<const BufferIds &> prepareIspComplete;
